...
('Rohan', 'Verma', 'rohan.verma@college.edu', '2002-11-30', 2, 2021),
('Sneha', 'Patel', 'sneha.patel@college.edu', '2004-01-15', 3, 2023),
('Vikram', 'Singh', 'vikram.singh@college.edu', '2003-09-10', 2, 2022),
('Anjali', 'Rao', 'anjali.rao@college.edu', '2002-05-18', 3, 2021),
('Karan', 'Shah', 'karan.shah@college.edu', '2004-08-22', 4, 2023),
('Meera', 'Joshi', 'meera.joshi@college.edu', '2003-12-05', 1, 2022);

INSERT INTO courses (course_name, course_code, credits, department_id) VALUES
('Database Systems', 'CS101', 4, 1),
('Operating Systems', 'CS102', 4, 1),
('Digital Electronics', 'EC201', 3, 2),
('Fluid Mechanics', 'ME201', 4, 3),
...
VALUES
('Harini', 'SG', 'harini.sg@college.edu', '2006-03-10', 1, 2023),
('Nithya', 'Raman', 'nithya.raman@college.edu', '2005-08-20', 2, 2023);
